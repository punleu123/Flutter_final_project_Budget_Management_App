...
class MockDataGenerator {
  ...
  static Future<void> _createCategories() async {
    try {
      ...
      debugPrint('✅ Categories created: ${categories.length}');
    } catch (e) {
  ...
  static Future<void> _createBudgetTemplates() async {
    try {
      ...
      debugPrint('✅ Budget templates created: ${templates.length}');
    } catch (e) {
      debugPrint('❌ Error creating budget templates: $e');
    }
  }
  ...
  static Future<void> _createDecemberTransactions() async {
    try {
      ...
      debugPrint('❌ Error creating December transactions: $e');
    }
  }
  ...
  static Future<void> _createJanuaryTransactions() async {
    try {
      ...
      debugPrint('❌ Error creating January transactions: $e');
    }
  }
}
